...
module.exports = {
  // ===== BOT CORE SETTINGS =====
  SESSION_ID: process.env.SESSION_ID || "suho~p3UgBayb#HgZBktD9qgBm7e5-0mZstq6m3Ew6-GFlbkGHxODshBE", // Your bot's session ID (keep secure)
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "254748803705", // Owner WhatsApp number
  OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "ᴍonkey", // Owner name
  DEV: process.env.DEV || "254748803705", // Developer contact number
